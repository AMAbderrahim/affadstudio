...
- [ ] Verify no quotes or spaces in `.env.local`
...
- [ ] API key is stored in Cloudflare secrets (not in code)
...
- **Worker:** [WORKER_SETUP.md](WORKER_SETUP.md)
- **Migration:** [GEMINI_MIGRATION.md](GEMINI_MIGRATION.md)
